...
export class IsDataURITypeValidator implements ValidatorConstraintInterface {
   ...
   *        The value to check.
   * @param args -
   *        The arguments that contain the mime type constraints.
   *
   * @returns
   *        True if the mime type detected in value exists within arguments.constraints.  False otherwise.
   */
 ...
 *
 * @returns
 *        A decorator function that applies the constraint.
 */
